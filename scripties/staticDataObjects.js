...
const SpecialEffieciencies = Object.freeze(["Terrifying Pact", "Eventide Afterglow", "Galvanized Mast", "Loaded Dice", "Sprouting Salts", "Midas Overflow", "Cleaving Strike", "Volcanic Eruption",
                                            "Tactical Insight", "Searing Light", "Astral Awakening", "Command Supremacy", "Weakpoint Throw",
                                            "Lightning Strike", "Burning Passion", "Phantom Vengeance", "Divine Wrath",
                                            "Phantom Control", "Stroke of Luck", "Deadly Focus", "Barbaric Fury", "Mark of Death", "Voltaic Sails","Ember Arts"]);
...
, rogue: "xRogue", fundamental: "xFundamental", sotv: "xSotV", fots: "xFotS", spiritsvigil: "xSpiritsVigil", titanslayer: "xTitanSlayer", weaponExpert: "xWeaponExpert", fotk: "xFotK", cobalt: "xTCP", deadlyStrikeCritDmg: "xDeadlyStrikeCritDamage"
});
var sampleArtifacts = {
"Book of Shadows": {
    "enchanted": "True",
...
var typeConversions = {
    ...
    ForbiddenContractBonusGold: Types.Gold.All,
    ...
    RoyalContractBonusDamage: Types.all,
    ...
    CritBoostSkillCritDamage: Types.deadlyStrikeCritDmg,
...
const activeSpCsv =  (location.hostname === "localhost" || location.hostname === "127.0.0.1" || location.hostname === "") ? "../assets/SkillTreeInfo2-14-23.csv" : "../tt2/assets/SkillTreeInfo2-14-23.csv";
const activeArtifactCsv = (location.hostname === "localhost" || location.hostname === "127.0.0.1" || location.hostname === "") ? "../assets/ArtifactInfo10-4-22.csv" : "../tt2/assets/ArtifactInfo10-4-22.csv";

const saveTalentIDSlots = {
    "CritSkillBoost": "6",
    "ForbiddenContract": "7",
    "HelperDmgQTE": "7",
    "KratosSummon": "8",
    ...
    "MidasSkillBoost": "3",
    "Backstab": "4",
    "HelperBoostMultiCastSkill": "8",
    "HelperDmgSkillBoost": "2",
    "AllHelperDmg": "0",
    "BossTimer": "5",
    "HeavyStrikes": "4",
    "Transmutation": "0",
    "ClanShipVoltageMultiCastSkill": "12",
    "CritSkillBoostDmg": "1",
    "GuidedBlade": "7",
    "MPCapacityBoost": "1",
    "HandOfMidasMultiCastSkillBoost": "6",
    "ManaMonster": "4",
    "ManaStealSkillBoost": "3",
    "LovePotion": "5",
    "TapDmg": "0",
    "TapDmgFromHelpers": "1",
    "BurstSkillBoost": "2",
    ...
    "FairyChance": "6",
    "Frenzy": "7",
    "BurstDamageMultiCastSkill": "8",
    "TwilightGathering": "9",
    "TwilightGatheringMultiCastSkill": "12",
    "PetDmg": "0",
    "FireTapSkillBoost": "1",
    "PetBonusBoost": "4",
    "PetQTE": "5",
    "TapBoostMultiCastSkill": "7",
    "BossDmgQTE": "8",
    "DualPetBoost": "9",
    "DualPetMultiCast": "12",
    "CloneDmg": "0",
    "CloneSkillBoost": "2",
    "ShadowCloneMultiCastSkill": "8",
    "PuppetMaster": "9",
    "TerrifyingPact": "10",
    "UltraDagger": "2",
    "Cloaking": "3",
    "MultiMonsters": "6",
    "CriticalHit": "8",
    "StreamOfBladesMultiCastSkill": "11",
    "GoldGun": "1",
    "ChestGold": "2",
    "MagnumOpus": "4",
    "AuricShot": "7"
}
const saveTalentIDClass = {
    "CritSkillBoost": "Sorcerer",
    "ForbiddenContract": "Sorcerer",
    "HelperDmgQTE": "Warlord",
    "KratosSummon": "Alchemist",
    "LoadedDice": "Rogue",
    "PetGoldQTE": "Pet",
    "HelperBoost": "Warlord",
    "CombatTechniques": "Pet",
    "ClanShipStun": "Warlord",
    "ClanShipDmg": "Warlord",
    "HelperInspiredWeaken": "Warlord",
    "PoisonedBlade": "Rogue",
    "OfflineGold": "Rogue",
    "PetEquipmentBoost": "Pet",
    "RoyalContract": "Alchemist",
    "ClanQTE": "Warlord",
    "ClanShipVoltage": "Warlord",
    "MidasSkillBoost": "Alchemist",
    "Backstab": "Rogue",
    "HelperBoostMultiCastSkill": "Warlord",
    "HelperDmgSkillBoost": "Warlord",
    "AllHelperDmg": "Warlord",
    "BossTimer": "Sorcerer",
    "HeavyStrikes": "Knight",
    "Transmutation": "Alchemist",
    "ClanShipVoltageMultiCastSkill": "Warlord",
    "CritSkillBoostDmg": "Rogue",
    "GuidedBlade": "Rogue",
    "MPCapacityBoost": "Sorcerer",
    "HandOfMidasMultiCastSkillBoost": "Alchemist",
    "ManaMonster": "Sorcerer",
    "ManaStealSkillBoost": "Sorcerer",
    "LovePotion": "Alchemist",
    "TapDmg": "Knight",
    "TapDmgFromHelpers": "Knight",
    "BurstSkillBoost": "Knight",
    "FairyGold": "Knight",
    "BurstSkillMana": "Knight",
    "FairyChance": "Knight",
    "Frenzy": "Knight",
    "BurstDamageMultiCastSkill": "Knight",
    "TwilightGathering": "Knight",
    "TwilightGatheringMultiCastSkill": "Knight",
    "PetDmg": "Pet",
    "FireTapSkillBoost": "Pet",
    "PetBonusBoost": "Pet",
    "PetQTE": "Pet",
    "TapBoostMultiCastSkill": "Pet",
    "BossDmgQTE": "Pet",
    "DualPetBoost": "Pet",
    "DualPetMultiCast": "Pet",
    "CloneDmg": "Sorcerer",
    "CloneSkillBoost": "Sorcerer",
    "ShadowCloneMultiCastSkill": "Sorcerer",
    "PuppetMaster": "Sorcerer",
    "TerrifyingPact": "Sorcerer",
    "UltraDagger": "Rogue",
    "Cloaking": "Rogue",
    "MultiMonsters": "Rogue",
    "CriticalHit": "Rogue",
    "StreamOfBladesMultiCastSkill": "Rogue",
    "GoldGun": "Alchemist",
    "ChestGold": "Alchemist",
    "MagnumOpus": "Alchemist",
    "AuricShot": "Alchemist"
}