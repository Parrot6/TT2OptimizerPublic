var GitCommit = require('git/lib/git/internal/git_commit').GitCommit,
  GitTree = require('git/lib/git/internal/git_tree').GitTree,
  GitTag = require('git/lib/git/internal/git_tag').GitTag,
  GitBlob = require('git/lib/git/internal/git_blob').GitBlob;
