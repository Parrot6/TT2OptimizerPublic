var util = require('util'),
    fs = require('fs'),
    GitFileOperations = require('git/lib/git/git_file_operations').GitFileOperations,
    exec = require('child_process').exec,
    FileIndex = require('git/lib/git/file_index').FileIndex,
    Repository = require('git/lib/git/repository').Repository,
    Difference = require('git/lib/diff/diff').Difference;
