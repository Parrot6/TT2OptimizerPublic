var util = require('util'),
  GitObject = require('git/lib/git/git_object').GitObject,
  fs = require('fs'),
  LooseStorage = require('git/lib/git/loose_storage').LooseStorage,
  PackStorage = require('git/lib/git/pack_storage').PackStorage,
  BinaryParser = require('git/lib/git/binary_parser').BinaryParser;
