var Head = require('git/lib/git/head').Head,
  Git = require('git/lib/git/git').Git,
  Commit = require('git/lib/git/commit').Commit,
  fs = require('fs'),
  util = require('util'),
  Tree = require('git/lib/git/tree').Tree,
  Blob = require('git/lib/git/blob').Blob,
  Head = require('git/lib/git/head').Head,
  Tag = require('git/lib/git/tag').Tag,
  Remote = require('git/lib/git/remote').Remote,
  Blame = require('git/lib/git/blame').Blame,
  CommitStats = require('git/lib/git/commit_stats').CommitStats,
  Config = require('git/lib/git/config').Config,
  Status = require('git/lib/git/status').Status,
  GitIndex = require('git/lib/git/git_index').GitIndex;
