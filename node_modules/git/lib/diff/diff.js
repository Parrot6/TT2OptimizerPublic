var util = require('util'),
  SequenceCallbacks = require('git/lib/diff/callbacks').SequenceCallbacks,
  ContextChange = require('git/lib/diff/change').ContextChange,
  Change = require('git/lib/diff/change').Change,
  DiffCallbacks = require('git/lib/diff/callbacks').DiffCallbacks,
  SDiffCallbacks = require('git/lib/diff/callbacks').SDiffCallbacks,
  BalancedCallbacks = require('git/lib/diff/callbacks').BalancedCallbacks,
  ContextDiffCallbacks = require('git/lib/diff/callbacks').ContextDiffCallbacks,
  Hunk = require('git/lib/diff/hunk').Hunk;
